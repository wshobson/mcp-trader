...
- **analyze-crypto**: Performs technical analysis on a given crypto asset (supports Tiingo and Binance)
  ...
  - Returns comprehensive technical analysis including:
    ...
    - Volatility metrics (ATR, ADRP)
    - Volume analysis
    - Trend status (above/below key SMAs, bullish crossovers)
    - Latest price and average volume
...
The server provides full technical analysis for major cryptocurrencies via the `analyze-crypto` tool:

- **Supported Providers**: Tiingo (spot pairs, e.g. BTCUSD), Binance (spot pairs, e.g. BTCUSDT)
- **Supported Assets**: Any crypto asset available on Tiingo or Binance
- **Indicators**:
  - Moving averages (SMA 20, 50, 200)
  - Momentum (RSI, MACD)
  - Volatility (ATR, ADRP)
...
- **Trend Analysis**:
  - Above/below key SMAs
  - Bullish/bearish crossovers
- **Output**:
  - Technical summary with trend, momentum, volatility, and volume metrics
  - Latest price and average volume

Crypto analysis is available via both HTTP and Claude Desktop integration, using the same API as for stocks.
